...
import { SupervivenciaGame } from './supervivencia.js?v=4';
import { StoryMode } from './story.js?v=4';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 2. Bloquear atajos de teclado de herramientas de desarrollador (F12, Ctrl+Shift+I, Ctrl+Shift+J, Ctrl+Shift+C, Ctrl+U)
    ...
    // 3. Silenciar todos los logs informativos de consola en producción
    const silenciarConsola = true; // Cambiar a false si necesitas hacer pruebas con la consola abierta
    if (silenciarConsola) {
